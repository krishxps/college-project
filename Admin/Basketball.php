            ...
            <div class="card card-primary">
              ...
              <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                 ...
                 <div class="form-group">
                    <label for="exampleInputP6name">Player 6 ID</label>
...
if(isset($_POST['insert1']))
{
 ...
 $P2_id = $_POST['P2_id'];
  ...
  $check_duplicate_email = "SELECT P1_id,P2_id,P3_id,P4_id,P5_id,P6_id,P7_id,P8_id from basketball WHERE P1_id = '$P1_id',P2_id = '$P2_id',P3_id = '$P3_id',P4_id = '$P4_id',P5_id = '$P5_id',P6_id = '$P6_id',P7_id = '$P7_id',P8_id = '$P8_id' ";
    $result = mysqli_query($conn, $check_duplicate_email);
    $count = mysqli_num_rows($result);
    if ($count > 0)
    {
      ?> <script type="text/javascript">
        alert("Player already registered for this sports!!!");
      </script>       
       <?php   
    }
 ...
 $insert = "INSERT INTO `basketball`(`Tname`,`P1_id`, `P2_id`, `P3_id`, `P4_id`, `P5_id`, `P6_id`, `P7_id`, `P8_id`) VALUES ('$Tname','$P1_id','$P2_id','$P3_id','$P4_id','$P5_id','$P6_id','$P7_id','$P8_id')";
