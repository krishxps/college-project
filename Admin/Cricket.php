              ...
              <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="P1name" id="P1name"placeholder="Enter Player 1 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP2name">Player 2 ID</label>
                    <input type="text" class="form-control" name="P2name" id="P2name"placeholder="Enter Player 2 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP3name">Player 3 ID</label>
                    <input type="text" class="form-control" name="P3name" id="P3name"placeholder="Enter Player 3 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP4name">Player 4 ID</label>
                    <input type="text" class="form-control" name="P4name" id="P4name"placeholder="Enter Player 4 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP5name">Player 5 ID</label>
                    <input type="text" class="form-control" name="P5name" id="P5name"placeholder="Enter Player 5 ID" required>
                  </div>
                 <div class="form-group">
                    <label for="exampleInputP5name">Player 6 ID</label>
                    <input type="text" class="form-control" name="P6name" id="P6name"placeholder="Enter Player 6 ID" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="exampleInputP9_id">Player 9 ID</label>
                    <input type="text" class="form-control" name="P9_id" id="P9_id"placeholder="Enter Player 9 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP10_id">Player 10 ID</label>
                    <input type="text" class="form-control" name="P10_id" id="P10_id"placeholder="Enter Player 10 ID" required>
                  </div>
                 
                  <div class="form-group">
                    <label for="exampleInputP11_id">Player 11 ID</label>
                    <input type="text" class="form-control" name="P11_id" id="P11_id"placeholder="Enter Player 11 ID" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP11name">Player 12 ID</label>
                    <input type="text" class="form-control" name="P12_id" id="P12_id"placeholder="Enter Player 12 ID" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP11name">Player 13 ID</label>
                    <input type="text" class="form-control" name="P13_id" id="P13_id"placeholder="Enter Player 13 ID" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP11name">Player 14 ID</label>
                    <input type="text" class="form-control" name="P14_id" id="P14_id"placeholder="Enter Player 14 ID" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP11name">Player 15 ID</label>
                    <input type="text" class="form-control" name="P15_id" id="P15_id"placeholder="Enter Player 15 ID" required>
                  </div>
                  <!-- /.button -->
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "INSERT INTO `cricket`(`Tname`,`P1_id`, `P2_id`, `P3_id`, `P4_id`, `P5_id`, `P6_id`, `P7_id`, `P8_id`, `P9_id`, `P10_id`, `P11_id`, `P12_id`, `P13_id`, `P14_id`, `P15_id`) VALUES ('$Tname','$P1_id','$P2_id','$P3_id','$P4_id','$P5_id','$P6_id','$P7_id','$P8_id','$P9_id','$P10_id','$P11_id','$P12_id','$P13_id','$P14_id','$P15_id')";
