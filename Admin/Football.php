                ...
                <div class="card-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="P7name" id="P7name"placeholder="Enter Player 7 ID" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP5name">Player 8 ID</label>
                    <input type="text" class="form-control" name="P8name" id="P8name"placeholder="Enter Player 8 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP9name">Player 9 ID</label>
                    <input type="text" class="form-control" name="P9name" id="P9name"placeholder="Enter Player 9 ID" required>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputP10name">Player 10 ID</label>
                    <input type="text" class="form-control" name="P10name" id="P10name"placeholder="Enter Player 10 ID" required>
                  </div>
                 
                  <div class="form-group">
                    <label for="exampleInputP11name">Player 11 ID</label>
                    <input type="text" class="form-control" name="P11name" id="P11name"placeholder="Enter Player 11 ID" required>
                  </div>
                  <div class="form-group">
...
$P1_id = $_POST['P1_id'];
 ...
 $insert = "INSERT INTO `football`(`Tname`,`P1_id`, `P2_id`, `P3_id`, `P4_id`, `P5_id`, `P6_id`, `P7_id`, `P8_id`, `P9_id`, `P10_id`, `P11_id`, `P12_id`, `P13_id`, `P14_id`) VALUES ('$Tname','$P1_id','$P2_id','$P3_id','$P4_id','$P5_id','$P6_id','$P7_id','$P8_id','$P9_id','$P10_id','$P11_id','$P12_id','$P13_id','$P14_id')";
