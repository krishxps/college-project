...
$sql = "SELECT * FROM basketball ORDER BY B_id DESC ";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Basketball Players</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><a href="edit_basketball.php?id=<?php echo $rows['B_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_basketball.php?id=<?php echo $rows['B_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Basketball.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
