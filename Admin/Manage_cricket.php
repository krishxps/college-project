...
$sql = "SELECT * FROM cricket ORDER BY C_id DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><?php echo $rows['P1_id'];?></td>
                <td><?php echo $rows['P2_id'];?></td>
                <td><?php echo $rows['P3_id'];?></td>
                <td><?php echo $rows['P4_id'];?></td>
                <td><?php echo $rows['P5_id'];?></td>
                <td><?php echo $rows['P6_id'];?></td>
                <td><?php echo $rows['P7_id'];?></td>
                <td><?php echo $rows['P8_id'];?></td>
                <td><?php echo $rows['P9_id'];?></td>
                <td><?php echo $rows['P10_id'];?></td>
                <td><?php echo $rows['P11_id'];?></td>
                <td><?php echo $rows['P12_id'];?></td>
                <td><?php echo $rows['P13_id'];?></td>
                <td><?php echo $rows['P14_id'];?></td>
                <td><?php echo $rows['P15_id'];?></td>

                <td><i class="glyphicon glyphicon-file"></i><a href="editcricket.php?id=<?php echo $rows['C_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_cricket.php?id=<?php echo $rows['C_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Cricket.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
