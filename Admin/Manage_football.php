...
$sql = "SELECT * FROM football ORDER BY F_id DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><i class="glyphicon glyphicon-file"></i><a href="edit_football.php?id=<?php echo $rows['F_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_cricket.php?id=<?php echo $rows['F_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Football.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
