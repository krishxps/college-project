        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><a href="editplayer.php?id=<?php echo $rows['P_id'];?>"><ion-icon name="create-sharp"></ion-icon> </a>
                <a href="Delete.php?id=<?php echo $rows['P_id'];?>" onclick="return confirm('Want to delete this player??'); "><ion-icon name="trash-sharp"></ion-icon> </a>
                </td>
            </tr>
       <?php } ?>
                                </table>
...
<!-- ./wrapper -->
 <a href="Player.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Player</button></a>
<!-- jQuery -->
