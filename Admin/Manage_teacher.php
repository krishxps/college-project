...
$sql = "SELECT * FROM teacher ORDER BY Fname DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><a href="edit_teacher.php?id=<?php echo $rows['User_Id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_Teacher.php?id=<?php echo $rows['User_Id']; ?>" onclick="return confirm('Want to delete the teacher??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
       <?php } ?>
                                </table>
  <!-- Control Sidebar -->
...
<!-- ./wrapper -->
<a href="Teacher.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Teacher</button></a>
<!-- jQuery -->
