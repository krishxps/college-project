              ...
              <form method="POST" id="quickForm">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputFname1" placeholder="FirstName" name="Fname">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputMName1">Middle Name</label>
                    <input type="text" class="form-control" id="exampleInputMname" placeholder="MiddleName" name="Mname">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLName1">Last Name</label>
                    <input type="text" class="form-control" id="exampleInputLname" placeholder=" LastName" name="Lname">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputLName1">Contact</label>
                    <input type="text" class="form-control" id="exampleInputContact" placeholder=" Contact" name="Contact" maxlength="10">
                  </div>
                  
                                 
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" name="Eid">
                  </div>
                  <div class="form-group">
...
if (!$db_select) {
    ...
    $check_duplicate_email = "SELECT Eid from teacher WHERE Eid = '$Eid' ";
   ...
   {
    $insert = "INSERT INTO `teacher`(`Fname`, `Mname`, `Lname`, `Contact`, `Eid`, `Password`) values('$Fname','$Mname','$Lname','$Contact','$Eid','$Password')";
