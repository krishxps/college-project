...
<?php
 ...
 {
 $B_id = $_GET['id'];
 $sql = "SELECT * FROM basketball WHERE B_id ='" . $_GET["id"] . "'";
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `basketball` SET `Tname`='$Tname',`P1_id`='$P1_id',`P2_id`='$P2_id',`P3_id`='$P3_id',`P4_id`='$P4_id',`P5_id`='$P5_id', `P6_id`='$P6_id', `P7_id`='$P7_id', `P8_id`='$P8_id' WHERE `B_id` ='" . $_GET["id"] . "'";
