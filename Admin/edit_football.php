            ...
            <div class="card card-primary">
             ...
             <form action="<?php $_PHP_SELF ?>" method="post">
                ...
                <div class="form-group">
                    <label for="exampleInputP1name">Team Name</label>
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `football` SET `Tname`='$Tname',`P1_id`='$P1_id',`P2_id`='$P2_id',`P3_id`='$P3_id',`P4_id`='$P4_id',`P5_id`='$P5_id', `P6_id`='$P6_id', `P7_id`='$P7_id', `P8_id`='$P8_id', `P9_id`='$P9_id', `P10_id`='$P10_id', `P11_id`='$P11_id', `P12_id`='$P12_id', `P13_id`='$P13_id', `P14_id`='$P14_id' WHERE `F_id` ='" . $_GET["id"] . "'";
