              ...
              <form id="quickForm" action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Fname" id="exampleInputFname" value="<?php echo $Fname;?>"placeholder="<?php echo $Fname;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputMname">Middle Name</label>
                    <input type="text" class="form-control" name="Mname" id="exampleInputMname" value="<?php echo $Mname;?>" placeholder="<?php echo $Mname;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLname">Last Name</label>
                    <input type="text" class="form-control" name="Lname" id="exampleInputLname" value="<?php echo $Lname;?>" placeholder="<?php echo $Lname;?>" required>
                  </div>
                  <!-- radio -->
                  <table>
                  <tr>
                     ...
                     <td> <b>Gender:</b> <div class="form-group">
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio1" name="Gender" value="<?php echo $Gender;?>">
                          <label for="customRadio1" class="custom-control-label">Male</label>
                        </div></div>
                       <div class="form-group">
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio2" name="Gender" value="<?php echo $Gender;?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="Eid" id="exampleInputEid" value="<?php echo $Eid;?>" placeholder="<?php echo $Eid;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputBdate">Birthdate</label>
                    <input type="text" class="form-control" name="Bdate" id="exampleInputBdate" value="<?php echo $Bdate;?>" placeholder="<?php echo $Bdate;?>" required>
                  </div> <div class="form-group">
                    <label for="exampleInputContact">Contact</label>
                    <input type="text" class="form-control" name="Contact" id="exampleInputContact" value="<?php echo $Contact;?>" placeholder="<?php echo $Contact;?>" required>
                  </div>
                </div>      
                <!-- /.button -->
...
$Fname = $_POST['Fname'];
 ...
 $insert = "UPDATE `player` SET `Fname`='$Fname',`Mname`='$Mname',`Lname`='$Lname',`Gender`='$Gender',`Eid`='$Eid',`Bdate`='$Bdate',`Contact`='$Contact' WHERE `P_id` ='" . $_GET["id"] . "'";
