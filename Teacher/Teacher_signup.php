...
<div class="signup-form">
	...
	<div class="text-center">Already have an account? <a href="Teacher_login">Sign in</a></div>
</div>
 <?php
...
if (!$db_select) {
    ...
    $insert = "INSERT INTO `teacher`(`Fname`, `Lname`, `Contact`, `Eid`, `Password`, `Cpassword`) values('$Fname','$Lname','$Contact','$Eid','$Password','$Cpassword')";
