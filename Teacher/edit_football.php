...
<?php
 ...
 {
 $F_id = $_GET['id'];
 $sql = "SELECT * FROM football WHERE F_id ='" . $_GET["id"] . "'";
...
// LOOP TILL END OF DATA 
                ...
                $P12name = $rows['P12name'];
                $P13name = $rows['P13name'];
                $P14name = $rows['P14name'];
            ...
            <div class="card card-primary">
             ...
             <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputP12name">Player 12 Name</label>
                    <input type="text" class="form-control" name="P12name" id="P12name" value="<?php echo $P12name;?>"placeholder="<?php echo $P12name;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP13name">Player 13 Name</label>
                    <input type="text" class="form-control" name="P13name" id="P13name" value="<?php echo $P13name;?>"placeholder="<?php echo $P13name;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputP14name">Player 14 Name</label>
                    <input type="text" class="form-control" name="P14name" id="P14name" value="<?php echo $P14name;?>"placeholder="<?php echo $P14name;?>" required>
                  </div>
                  <!-- /.button -->
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `football` SET `P1name`='$P1name',`P2name`='$P2name',`P3name`='$P3name',`P4name`='$P4name',`P5name`='$P5name', `P6name`='$P6name', `P7name`='$P7name', `P8name`='$P8name', `P9name`='$P9name', `P10name`='$P10name', `P11name`='$P11name' WHERE `F_id` ='" . $_GET["id"] . "'";
