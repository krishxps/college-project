...
<head>
	...
	<title>Football Team Name</title>
</head>
<body>
  ...
  <div class="container px-5 py-24 mx-auto text-center">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-black-900">Football Teams</h1>
          ...
          <div class="flex-grow">
           <?php
              ...
              if ($mysqli->connect_error) {
               ...
               $sql = "SELECT * FROM football where F_id = 3";
              $result = $mysqli->query($sql);
                while($rows=mysqli_fetch_array($result))
                {
             ?>
             
           <h2 class="text-gray-900 title-font font-medium"><?php echo $rows['Tname'];?></h2>
           ...
           <p class="text-black-500"><?php echo $rows['P1_id'];?></p>
            ...
            <p class="text-black-500"><?php echo $rows['P6_id'];?></p>
            <p class="text-black-500"><?php echo $rows['P7_id'];?></p>
            <p class="text-black-500"><?php echo $rows['P8_id'];?></p>
            <p class="text-black-500"><?php echo $rows['P9_id'];?></p>
            <p class="text-black-500"><?php echo $rows['P10_id'];?></p>
            <p class="text-black-500"><?php echo $rows['P11_id'];?></p>
          <?php } ?>
          </div>
        </div>
      </div>
        ...
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
         <div class="flex-grow">
          <?php
              ...
              $sql = "SELECT * FROM football where F_id = 5 ";
              $result = $mysqli->query($sql);
        ...
        <div class="h-full flex items-center border-black-200 border p-4 rounded-lg">
          <div class="flex-grow">
             <?php
              ...
              // SQL query to select data from database
              $sql = "SELECT * FROM football where F_id = 7 ";
              $result = $mysqli->query($sql);
