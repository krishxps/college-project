...
$sql = "SELECT * FROM match_score ORDER BY Match_Id DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><?php echo $rows['Over'];?></td>
                <td><?php echo $rows['four']?></td>
                <td><?php echo $rows['six'];?></td>
                <td><?php echo $rows['Run'];?></td>
                <td><?php echo $rows['Wicket'];?></td>
                <td><?php echo $rows['Wide'];?></td>
            </tr>
       <?php } ?>
                                </table>
                                </center>
