...
if(!isset($_SESSION['P_id'])){
  ...
  $sql = "SELECT * FROM football_score ORDER BY F_id DESC ";
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <div class="container">
          <h1 class="display-4">FOOTBALL SCORE</h1>
        </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><?php echo $rows['T1_goals']?></td>
                <td><?php echo $rows['T2_goals'];?></td>
                <td><?php echo $rows['No_of_goals'];?></td>
